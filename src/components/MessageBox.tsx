            ...
            {clientSentMsg ? (
                <div className='flex flex-row items-center'>
                    <div className='flex flex-row items-center ml-auto'
                        ...
                        <div
                            key={messageKey}
                            className={`bg-blue-500 p-2 flex items-center justify-between rounded-md max-w-md mb-3 ${hovered ? '' : 'mr-5'}`}>
                ...
                <div className='flex flex-col'>
                    ...
                    <div className='flex flex-row items-center mr-auto'
                        ...
                        <div
                            key={messageKey}
                            className={`bg-gray-300 p-2 flex items-center justify-between mr-auto rounded-md max-w-md mb-3 ml-5`}>
